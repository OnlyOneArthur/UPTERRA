  ...
  return (
    <div className="min-h-screen bg-[#f6f6f4] font-poppins">
      <div className="mx-auto max-w-md pb-28">
        ...
        <header className="bg-white px-5 pt-6 pb-4 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="relative flex h-9 w-9 items-center justify-center rounded-full bg-[#f0f0f0]">
        ...
        {/* Category Tabs */}
        <div className="mt-5 flex gap-3 overflow-x-auto px-5 pb-1 scrollbar-hide">
          {categories.map((cat) => (
            <button
              key={cat}
              onClick={() => setActiveCategory(cat)}
              className={`whitespace-nowrap px-1 pb-2 text-[12px] font-semibold transition-all ${
                activeCategory === cat
