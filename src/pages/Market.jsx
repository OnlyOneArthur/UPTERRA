...
export const products = [
  // ── komponen PC ─────────────────────────────────────────────────────────────
  {
    ...
    description: "Apple Magic Keyboard second hand kondisi mulus, tuts semua berfungsi normal. Sudah dibersihkan.",
    variants: [
  ...
  },
  {
    ...
    price: 280000,
    image: "https://images.unsplash.com/photo-1562976540-1502c2145896?auto=format&fit=crop&w=400&q=80",
    rating: 4.3,
    sold: 15,
    category: "komponen PC",
  ...
  },
  {
    ...
    description: "Mouse Logitech MX Master 3 second, kondisi sangat baik. Scroll wheel dan semua tombol normal.",
    variants: [
  ...
  },
  {
    ...
    description: "SSD SATA 256GB second, sudah diformat dan siap pakai. Health 95%+ semua merk acak.",
    variants: [
  ...
  },
  {
    ...
    description: "Totebag ramah lingkungan dari bahan karung goni daur ulang. Kuat dan bisa dipakai belanja harian.",
    variants: [
  ...
  },
  {
    ...
    category: "Tas",
    location: "Bali, Bali",
    description: "Tas anyaman rotan asli buatan pengrajin lokal Bali. Cocok untuk hangout maupun ke pantai.",
    variants: [
      { label: "natural", color: "#C4A882" },
  ...
  // ── Sparepart ───────────────────────────────────────────────────────────────
  {
    ...
    price: 150000,
    image: "https://images.unsplash.com/photo-1603539947678-cd3954ed515d?auto=format&fit=crop&w=400&q=80",
    rating: 4.1,
    sold: 19,
    category: "Sparepart",
    location: "Jakarta, DKI Jakarta",
    description: "Baterai laptop Asus VivoBook second original, kapasitas masih 80%+. Cocok untuk pengganti baterai drop.",
    variants: [
  ...
  },
  {
    ...
    category: "Sparepart",
    location: "Bandung, Jawa Barat",
    description: "Charger laptop universal 65W second, sudah ditest berfungsi normal. Cocok untuk berbagai merek.",
    variants: [
  ...
  },
  {
    ...
    category: "Sparepart",
    location: "Surabaya, Jawa Timur",
    description: "Panel layar LCD 14 inch FHD IPS second, tidak ada dead pixel, backlight merata.",
    variants: [
  ...
  },
  {
    ...
    price: 135000,
    image: "https://images.unsplash.com/photo-1513506003901-1e6a35359a28?auto=format&fit=crop&w=400&q=80",
    rating: 4.8,
    sold: 37,
    category: "Produk Populer",
    location: "Yogyakarta, DIY",
    description: "Lampu hias aesthetic dari botol kaca dan kayu palet bekas. Cocok untuk dekorasi kamar atau cafe.",
    variants: [
  ...
  },
  {
    ...
    description: "Dompet handmade dari kantong plastik daur ulang yang dianyam rapi. Unik, kuat, dan ramah lingkungan.",
    variants: [
    ...
    <div className="min-h-screen bg-[#f6f6f4]">
      <div className="mx-auto max-w-md pb-24">
        ...
        <header className="sticky top-0 z-20 bg-white px-5 pt-6 pb-4 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
          ...
          >
            <Search size={16} className={isSearchFocused ? "text-[#3da85e]" : "text-[#aaa]"} />
            <input
              ref={searchRef}
              type="text"
              value={searchQuery}
          ...
          <div className="px-5 pt-4">
            ...
            {filtered.length === 0 ? (
              <div className="flex flex-col items-center py-16 text-center">
                ...
                <p className="text-[14px] font-semibold text-[#2d2d2d]">Produk tidak ditemukan</p>
